...
public enum UnitType {
    ...
    ARCHER(200,100,0.15,4,7,3,12,0.3,0,WeaponType.BOW, null,false,false,false,"archer", true),
    CROSSBOW_MAN(250, 120, 0.2, 3, 4, 0, 20, 0.1, 0, WeaponType.CROSSBOW, WeaponType.LEATHER_ARMOR, false, false, false, "crossbow man", true),
    SPEAR_MAN(150, 180, 0.1, 3 ,1, 0, 8, 0.1, 2, WeaponType.SPEAR, null, true, true, false, "spear man", false),
    ...
    SWORDS_MAN(250, 350, 0.27, 1, 1, 0, 40, 0, 3, WeaponType.SWORDS, WeaponType.METAL_ARMOR, false, true, false, "swordsman", false),
    KNIGHT(600, 400, 0.35, 4, 1, 0, 120, 0, 0, WeaponType.SWORDS, WeaponType.METAL_ARMOR, false, false, false, "knight", false),
    ...
    ARCHER_BOW(200, 100, 0.12, 3, 8, 5, 75, 0.3, 0, WeaponType.BOW, null, false, false, true, "archer bow", true),
    ...
    ASSASSIN(400, 300, 0.3, 2, 1, 0, 100, 0, 0, null, null, true, false, true, "assassin", false),
    HORSE_ARCHER(300, 120, 0.2, 5, 6, 2, 60, 0.5, 0, WeaponType.BOW, null, false, false, true, "horse archer", true),
    ARABIAN_SWORDSMAN(500, 220, 0.2, 4, 1, 0, 80, 0, 0, WeaponType.SWORDS, WeaponType.LEATHER_ARMOR, false, false, true, "arabian swordsman", false),
    FIRE_THROWER(150,100 , 0.1, 4, 3, 0, 70, 0.1, 0, null, null, false, false, true, "fire thrower", true),
